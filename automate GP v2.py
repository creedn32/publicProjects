...
selectedCells = sheet['A506':'I506']
caption = 'Bank Transaction Entry  -  GPTRN (CNAYLOR)'
pyautogui.PAUSE = .5
...
pyautogui.press(['up', 'up', 'up', 'up', 'tab', 'up', 'up', 'up', 'up', 'tab'])
pyautogui.typewrite(str(selectedCells[0][2].value))
pyautogui.press('tab')
pyautogui.typewrite(str(selectedCells[0][3].value))
pyautogui.press(['tab', 'tab'])
pyautogui.typewrite(str(selectedCells[0][4].value))
pyautogui.press('tab')
pyautogui.typewrite(str(selectedCells[0][5].value))
pyautogui.press('tab')
pyautogui.typewrite(str(selectedCells[0][6].value))
pyautogui.press('tab')
