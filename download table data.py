...
import win32com.client, time, datetime, bs4, os
...
chromeDriver.get("https://www..com/")
time.sleep(pageLoadTime)

chromeDriver.find_element_by_xpath("//*[@id=\"blogin\"]/li[2]/a").click()
time.sleep(pageLoadTime / 3)

chromeDriver.find_element_by_xpath("//*[@id=\"Email\"]").send_keys("example@gmail.com")
chromeDriver.find_element_by_xpath("//*[@id=\"Password\"]").send_keys("password")
